library asset_mathedit_lib_components_preview_component_preview_component.template.dart;

import 'package:angular2/src/core/change_detection/pregen_proto_change_detector.dart' as import0;
import 'package:mathedit/components/preview_component/preview_component.dart' as import1;
import 'package:angular2/src/core/linker/template_commands.dart' as import2;
import 'package:mathedit/components/preview_component/preview_component.css.dart' as import3;
...
const PreviewComponentTemplate = const import2.CompiledComponentTemplate('asset:mathedit/lib/components/preview_component/preview_component.dart|PreviewComponent',_PreviewComponent_0.newChangeDetector,const [const import2.BeginElementCmd('div', const ['class','preview','id','preview'], const [], const [], const [], false, null),const import2.EndElementCmd(),const import2.TextCmd('\n\n', false, null),const import2.BeginElementCmd('div', const ['class','preview','id','buffer','style','visibility: hidden; position: absolute'], const [], const [], const [], false, null),const import2.EndElementCmd()],const [import3.STYLES]);
PreviewComponentTemplateGetter() => PreviewComponentTemplate;
const HostPreviewComponentTemplate = const import2.CompiledHostTemplate(const import2.CompiledComponentTemplate('asset:mathedit/lib/components/preview_component/preview_component.dart|HostPreviewComponent',_HostPreviewComponent_0.newChangeDetector,const [const import2.BeginComponentCmd('preview', const [], const [], const [], const [import1.PreviewComponent], import2.ViewEncapsulation.None, null, PreviewComponentTemplateGetter),const import2.EndComponentCmd()],const []));

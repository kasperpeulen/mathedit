...
import 'package:mathedit/components/math_edit.component/math_edit.component.css.dart' as import7;
      ...
      class _MathEditComponent_0 extends import0.AbstractChangeDetector<import1.MathEditComponent> {
        var operation_negate1, gistValue2, directive_0_0, directive_1_0;
        ...
        void detectChangesInRecordsInternal(throwOnChange) {
          var l_context = this.context,l_loaded0,l_operation_negate1,l_gistValue2;
          var isChanged = false;
          var changes = null;
...
this.directive_1_0 = this.getDirectiveFor(directives, 1);  }
        ...
        void dehydrateDirectives(destroyPipes) {  this.operation_negate1 = this.gistValue2 = this.directive_0_0 = this.directive_1_0 = import0.ChangeDetectionUtil.uninitialized; }

        static final _gen_propertyBindingTargets = [import0.ChangeDetectionUtil.bindingTarget("elementProperty", 0, "hidden", null, "!loaded in MathEditComponent@0:8"), import0.ChangeDetectionUtil.bindingTarget("directive", 0, "textareaValue", null, "AST")];

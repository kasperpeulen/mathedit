...
const HostMathEditComponentTemplate = const import2.CompiledHostTemplate(const import2.CompiledComponentTemplate('asset:mathedit/lib/components/math_edit.component/math_edit.component.dart|HostMathEditComponent',_HostMathEditComponent_0.newChangeDetector,const [const import2.BeginComponentCmd('math-edit', const [], const [], const [], const [import1.MathEditComponent], import2.ViewEncapsulation.None, null, MathEditComponentTemplateGetter),const import2.EndComponentCmd()],const []));

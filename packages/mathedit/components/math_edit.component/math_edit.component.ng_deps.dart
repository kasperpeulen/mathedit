...
const [const [Router], const [RouteParams], const [ElementRef], const [CommonMarkParser], const [HtmlWriter], const [MyGistsService]],
(Router router, RouteParams params, ElementRef ref, CommonMarkParser cmParser, HtmlWriter htmlWriter, MyGistsService gistService) => new MathEditComponent(router, params, ref, cmParser, htmlWriter, gistService),
const [OnInit])
)
;
i0.initReflector();

...
const [const [RouteParams], const [ElementRef], const [CommonMarkParser], const [HtmlWriter], const [GistsService]],
(RouteParams params, ElementRef ref, CommonMarkParser cmParser, HtmlWriter htmlWriter, GistsService gistService) => new MathEditComponent(params, ref, cmParser, htmlWriter, gistService),
const [OnInit])
)
;
i0.initReflector();

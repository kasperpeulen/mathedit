...
import 'package:mathedit/components/login.component/login.component.dart' as import3;
import 'package:mathedit/components/login.component/login.component.template.dart' as import4;
import 'package:angular2/src/router/router_outlet.dart' as import5;
import 'package:mathedit/app.css.dart' as import6;


      class _AppComponent_0 extends import0.AbstractChangeDetector<import1.AppComponent> {
        var directive_0_0, directive_1_0;
...
this.directive_1_0 = this.getDirectiveFor(directives, 1);  }
        ...
        void dehydrateDirectives(destroyPipes) {  this.directive_0_0 = this.directive_1_0 = import0.ChangeDetectionUtil.uninitialized; }
...
const AppComponentTemplate = const import2.CompiledComponentTemplate('asset:mathedit/lib/app.dart|AppComponent',_AppComponent_0.newChangeDetector,const [const import2.BeginComponentCmd('login', const [], const [], const [], const [import3.LoginComponent], import2.ViewEncapsulation.Emulated, null, import4.LoginComponentTemplateGetter),const import2.EndComponentCmd(),const import2.TextCmd('\n', false, null),const import2.BeginElementCmd('router-outlet', const [], const [], const [], const [import5.RouterOutlet], true, null),const import2.EndElementCmd()],const [import6.STYLES]);
